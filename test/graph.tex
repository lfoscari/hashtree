...
\begin{center}
	...
	\begin{tikzpicture}
		\begin{axis}[
				xlabel={$m$}, xmin=1, xmax=50,
				ylabel={$b$}, ymin=1, ymax=50,
				zlabel={Usage}, zmajorgrids=true,
				width=\textwidth * 0.5
			]
			\addplot3 [scatter, only marks, mark=+]
				table [x=m, y=b, z=var_usage, col sep=comma] {../resources/magic/magic04.out};
		\end{axis}
	\end{tikzpicture}
	...
	\begin{tikzpicture}
		\begin{axis}[
				xlabel={$m$}, xmin=1, xmax=50,
				ylabel={$b$}, ymin=1, ymax=50,
				zlabel={Depth}, zmajorgrids=true,
				width=\textwidth * 0.5
			]
			\addplot3 [scatter, only marks, mark=+]
				table [x=m, y=b, z=var_depth, col sep=comma] {../resources/magic/magic04.out};
		\end{axis}
	\end{tikzpicture}
...
\begin{center}
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\addplot3 [scatter, only marks, mark=+]
				table [x=m, y=b, z=var_usage, col sep=comma] {../resources/cloud/cloud.out};
		\end{axis}
	\end{tikzpicture}
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\addplot3 [scatter, only marks, mark=+]
				table [x=m, y=b, z=var_depth, col sep=comma] {../resources/cloud/cloud.out};
		\end{axis}
	\end{tikzpicture}
